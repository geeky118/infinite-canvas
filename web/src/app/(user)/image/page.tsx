                        ...
                        <div>
                            <div className="flex items-start justify-between gap-3">
                                <div className="min-w-0">
                                    <h1 className="text-2xl font-semibold text-slate-950 dark:text-sky-50">生图工作台</h1>
                                </div>
...
function ResultImageCard({
    ...
    return (
        <div className="overflow-hidden rounded-lg border border-blue-100 bg-white dark:border-sky-400/[0.12] dark:bg-white/[0.04]">
            ...
            <div className="space-y-2 border-t border-blue-100 px-3 py-2.5 dark:border-sky-400/[0.12]">
...
function PendingImageCard() {
    return (
        <div className="relative aspect-square overflow-hidden rounded-lg border border-dashed border-blue-200 bg-blue-50/70 dark:border-sky-400/[0.18] dark:bg-sky-400/10">
            <div
...
function LogCard({ log, selected, active, onSelectedChange, onClick }: { log: GenerationLog; selected: boolean; active: boolean; onSelectedChange: (checked: boolean) => void; onClick: () => void }) {
    ...
    return (
        <button
            type="button"
            className={`block w-full rounded-lg border p-2 text-left transition ${active ? "border-blue-600 bg-blue-50 text-blue-950 dark:border-sky-300 dark:bg-sky-400/[0.14] dark:text-sky-50" : "border-blue-100 bg-white/70 hover:bg-blue-50/70 dark:border-sky-400/[0.12] dark:bg-white/[0.03] dark:hover:bg-sky-400/10"}`}
            onClick={onClick}
        >
