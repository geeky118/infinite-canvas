...
export default function CanvasPage() {
    ...
    return (
        <main className="brand-app-bg h-full overflow-auto text-slate-950 dark:text-sky-50">
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-10">
                <header className="flex flex-wrap items-end justify-between gap-4 border-b border-blue-200/70 pb-6 dark:border-sky-400/[0.15]">
                    <div>
                        <p className="text-xs font-medium text-blue-600 dark:text-sky-300">画布库</p>
                ...
                {!hydrated || !cloudHydrated ? (
                    <section className="flex min-h-[360px] items-center justify-center border-y border-blue-200/70 text-sm text-slate-500 dark:border-sky-400/[0.15] dark:text-sky-100/[0.62]">正在加载画布...</section>
                ) : projects.length ? (
                    ...
                    <section className="flex min-h-[360px] flex-col items-center justify-center border-y border-blue-200/70 text-center dark:border-sky-400/[0.15]">
                        <h2 className="text-xl font-medium">还没有画布</h2>
                        <p className="mt-3 text-sm text-slate-500 dark:text-sky-100/[0.62]">新建一个画布后，就可以独立保存节点、连线和画布外观。</p>
